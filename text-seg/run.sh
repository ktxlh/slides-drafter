...
python finetune.py --pregenerated_data $PREGENERATE/ --bert_model bert-base-cased --output_dir $PREGENERATE/models/ --train_batch_size 32 --gradient_accumulation_steps 4 | tee output.txt
