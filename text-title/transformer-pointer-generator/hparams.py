...
class Hparams:
    ...
    # train
    ## files
    parser.add_argument('--train', default='./demo_data/train.csv',
                             help="data for train")

    parser.add_argument('--eval', default='./demo_data/val.csv',
                             help="data for evaluation")
    parser.add_argument('--eval_rouge', default='./demo_data/test_summary.csv',
