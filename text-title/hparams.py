...
class Hparams:
    ...
    # train
    ## files
    parser.add_argument('--train', default='/home/g54panguosheng/code/input.csv',
                             help="data for train")

    parser.add_argument('--eval', default='/home/g54panguosheng/code/val.csv',
                             help="data for evaluation")
    parser.add_argument('--eval_rouge', default='/home/g54panguosheng/test_summary.csv',
                             help="data for calculate rouge score")

    ## vocabulary
    parser.add_argument('--vocab', default='/home/g54panguosheng/code/vocab',
    ...
    parser.add_argument('--maxlen2', default=5, type=int,
