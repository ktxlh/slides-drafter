...
class Transformer:
    def __init__(self, hp):
        ...
        self.embeddings = get_token_embeddings(self.vocab_len, self.hp.d_model, zero_pad=True)
    ...
    def _calc_final_dist(self, x, gens, vocab_dists, attn_dists):
        ...
        with tf.variable_scope('final_distribution', reuse=tf.AUTO_REUSE):
            ...
            attn_dists_projected = tf.map_fn(fn=lambda y: tf.scatter_nd(y[0], y[1], [dec_t, self.vocab_len]),
